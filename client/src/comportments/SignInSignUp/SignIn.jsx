    ...
    <div className='bg-none py-8 rounded text-white'>
        <div className=''>
            <div className="mx-0 py-12 px-10 w-full">
                    <h1 className="text-gray-500 font-semibold">WELCOME BACK</h1>
                    <h1 className="text-3xl my-4 lib-title"></h1>
                    <form onSubmit={headleSubmit}>
                        ...
                        <div className="">
                            <button type='submit' className='w-full bg-blue-500 rounded-full py-4 px-8 text-white duration-500 hover:bg-blue-600 hover:shadow-md'>SignIn</button>
                        </div>
                    </form>
