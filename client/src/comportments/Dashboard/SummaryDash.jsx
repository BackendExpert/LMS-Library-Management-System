...
const SummaryDash = () => {
    ...
    const dataCount = [
        ...
        {id: 11, btnvalue: "rejectReq", name: "My Reject/Cancelled Requests", link: "#", value: <CountUp end={RejectReq}/>, icon: <Icons name="help-circle" size="large"></Icons>, style: "text-red-500"}, 
    ]
