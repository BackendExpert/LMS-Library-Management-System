...
const SummaryDash = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const BorrowedBKCount = await axios.get('http://localhost:8081/CountBorrowedBooks');
                SetBorrowedBooks(BorrowedBKCount.data.BorrowedBooks);
            } catch (error) {
                console.error('Error fetching data:', error);
            }
            ...
            try {
                const MyBorrowedBooks = await axios.get('http://localhost:8081/MyBorrowedBooks/' + EmailUser);
    ...
    const dataCount = [
        ...
        {id: 12, btnvalue: "adminStats", name: "Status for SuperAdmin", link: "#", icon: <Icons name="stats-chart" size="large"></Icons>, style: "text-red-500"},  
    ]
