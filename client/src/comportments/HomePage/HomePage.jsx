    ...
    <div>
                        ...
                        <div className="lg:flex">
                            <div className="lg:flex text-gray-300">                              
                                ...
                                <span className='mr-4'><img src={NIFSLogo} alt="" className='h-12 w-auto'/></span>
                                    <h1 className="italic mt-1 whitespace-nowrap lg:ml-[-15px] text-2xl font-semibold font-italic text-blue-400"> Library</h1>
                                    {
                                    (() => {
        ...
        <div className={`lg:px-24 px-10 py-20 ${Darkmode === true ? 'dark-mode duration-500' : 'light-mode bg-gray-200 duration-500'}`}>
            ...
            <div className="lg:flex justify-between my-4">
                <div className={`rounded py-10 px-8 shadow-md mx-2 lg:my-0 my-2 w-full  ${Darkmode === false ? 'text-gray-500 bg-white' : 'text-gray-200 bg-[#2c3646]'}`}>
                    <div className="flex">
        ...
        <div className={`lg:px-20 px-6 py-24  ${Darkmode === true ? 'dark-mode duration-500' : 'bg-white light-mode duration-500'}`}>
            ...
            <div className="lg:flex my-24">
                <div className={`py-8 px-4 mx-4 lg:my-0 my-12 rounded-lg shadow-xl lg:w-full ${Darkmode === false ? 'text-gray-500 bg-gray-200' : 'text-gray-200 bg-[#2c3646]'}`}>
